...
The following list are the *configuration properties* (aka _settings_) that you can use to configure a Spark SQL application.
...
Use link:spark-sql-SQLConf.adoc#adaptiveExecutionEnabled[adaptiveExecutionEnabled] method to access the current value.
...
Use link:spark-sql-SQLConf.adoc#autoBroadcastJoinThreshold[autoBroadcastJoinThreshold] method to access the current value.
...
Use link:spark-sql-SQLConf.adoc#cboEnabled[cboEnabled] method to access the current value.
...
Use link:spark-sql-SQLConf.adoc#joinReorderEnabled[joinReorderEnabled] method to access the current value.
...
Use link:spark-sql-SQLConf.adoc#starSchemaDetection[starSchemaDetection] method to access the current value.
...
Use link:spark-sql-SQLConf.adoc#wholeStageFallback[wholeStageFallback] method to access the current value.
...
Use link:spark-sql-SQLConf.adoc#wholeStageMaxNumFields[wholeStageMaxNumFields] method to access the current value.
...
Use link:spark-sql-SQLConf.adoc#wholeStageEnabled[wholeStageEnabled] method to access the current value.
...
Use link:spark-sql-SQLConf.adoc#defaultSizeInBytes[defaultSizeInBytes] method to access the current value.
...
Use link:spark-sql-SQLConf.adoc#useObjectHashAggregation[useObjectHashAggregation] method to access the current value.
...
| `1.2.1`
| Version of the Hive metastore. Supported versions from `0.12.0` up to and including `2.1.1`.
...
Use link:spark-sql-SQLConf.adoc#columnBatchSize[columnBatchSize] method to access the current value.

| [[spark.sql.inMemoryColumnarStorage.compressed]] `spark.sql.inMemoryColumnarStorage.compressed`
| `true`
| *(internal)* Controls...FIXME

Use link:spark-sql-SQLConf.adoc#useCompression[useCompression] method to access the current value.
...
Use link:spark-sql-SQLConf.adoc#preferSortMergeJoin[preferSortMergeJoin] method to access the current value.
...
Use link:spark-sql-SQLConf.adoc#limitScaleUpFactor[limitScaleUpFactor] method to access the current value.
...
Use link:spark-sql-SQLConf.adoc#dataFramePivotMaxValues[dataFramePivotMaxValues] method to access the current value.
...
Use link:spark-sql-SQLConf.adoc#dataFrameRetainGroupColumns[dataFrameRetainGroupColumns] method to access the current value.
...
Use link:spark-sql-SQLConf.adoc#runSQLonFile[runSQLonFile] method to access the current value.
...
Use link:spark-sql-SQLConf.adoc#numShufflePartitions[numShufflePartitions] method to access the current value.
...
Use link:spark-sql-SQLConf.adoc#fallBackToHdfsForStatsEnabled[fallBackToHdfsForStatsEnabled] method to access the current value.
...
Use link:spark-sql-SQLConf.adoc#histogramEnabled[histogramEnabled] method to access the current value.
...
Use link:spark-sql-SQLConf.adoc#histogramNumBins[histogramNumBins] method to access the current value.
...
Use link:spark-sql-SQLConf.adoc#autoSizeUpdateEnabled[autoSizeUpdateEnabled] method to access the current value.
