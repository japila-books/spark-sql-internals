== [[LimitPushDown]] LimitPushDown Logical Query Optimization
...
`LimitPushDown` is part of link:spark-sql-Optimizer.adoc#Operator-Optimizations[Operator Optimizations] batch in the base link:spark-sql-Optimizer.adoc[Optimizer].
