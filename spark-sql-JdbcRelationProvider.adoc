...
In the end, `createRelation` creates a link:spark-sql-JDBCRelation.adoc[JDBCRelation] using link:spark-sql-JDBCRelation.adoc#columnPartition[column partitions] (and link:spark-sql-JDBCOptions.adoc[JDBCOptions]).
