...
* [[analyzerBuilder]] `analyzerBuilder` function to create a <<spark-sql-Analyzer.adoc#, Analyzer>> (i.e. `() => Analyzer`)
* [[optimizerBuilder]] `optimizerBuilder` function to create a <<spark-sql-Optimizer.adoc#, Optimizer>> (i.e. `() => Optimizer`)
