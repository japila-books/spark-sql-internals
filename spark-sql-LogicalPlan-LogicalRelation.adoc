...
`LogicalRelation` is a link:spark-sql-LogicalPlan-LeafNode.adoc[leaf logical operator] that is an adapter for link:spark-sql-BaseRelation.adoc[BaseRelation] in a link:spark-sql-LogicalPlan.adoc[logical query plan].
