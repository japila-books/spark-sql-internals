== [[EnsureRequirements]] EnsureRequirements Physical Query Plan Optimization Rule
...
1. For link:spark-sql-BroadcastDistribution.adoc[BroadcastDistribution], the child becomes the child of link:spark-sql-SparkPlan-BroadcastExchangeExec.adoc[BroadcastExchangeExec] unary operator for broadcasting joins
