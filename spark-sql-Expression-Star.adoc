...
1. link:spark-sql-ResolveReferences.adoc#apply[ScriptTransformation]

1. link:spark-sql-ResolveReferences.adoc#buildExpandedProjectList[Project and Aggregate]
|===
