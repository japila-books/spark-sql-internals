...
NOTE: `WindowExpression` is used in <<spark-sql-Analyzer-ExtractWindowExpressions.adoc#, ExtractWindowExpressions>>, link:spark-sql-Analyzer.adoc#ResolveWindowOrder[ResolveWindowOrder] and link:spark-sql-Analyzer-ResolveWindowFrame.adoc[ResolveWindowFrame] logical evaluation rules.
