...
=== [[listColumns]] `listColumns` Internal Method
...
NOTE: `listColumns` is a part of link:spark-sql-Catalog.adoc#listColumns[Catalog Contract] to...FIXME.
...
NOTE: `refreshTable` is a part of link:spark-sql-Catalog.adoc#refreshTable[Catalog Contract] to...FIXME.
...
=== [[listTables]] Listing Tables in Database -- `listTables` Method
...
In the end, `listTables` <<makeDataset, creates a Dataset>>.
