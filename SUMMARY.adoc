...
. link:spark-sql-subexpression-elimination.adoc[Subexpression Elimination]
...
. link:spark-sql-ExtractEquiJoinKeys.adoc[ExtractEquiJoinKeys -- Destructuring Join Logical Operator]
