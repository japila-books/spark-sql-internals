...
. link:spark-sql-Dataset-typed-transformations.adoc[Dataset API -- Typed Transformations]
. link:spark-sql-Dataset-untyped-transformations.adoc[Dataset API -- Untyped Transformations]
. link:spark-sql-Dataset-basic-actions.adoc[Dataset API -- Basic Actions]
. link:spark-sql-Column.adoc[Column API -- Column Expressions and Operators]
. link:spark-sql-TypedColumn.adoc[TypedColumn]
. link:spark-sql-DataFrameNaFunctions.adoc[DataFrameNaFunctions]
. link:spark-sql-DataFrameStatFunctions.adoc[DataFrameStatFunctions]
...
. link:spark-sql-ConsumerStrategy.adoc[ConsumerStrategy]
...
. link:spark-sql-KafkaSourceOffset.adoc[KafkaSourceOffset]
...
. link:spark-sql-CreatableRelationProvider.adoc[CreatableRelationProvider Contract -- Data Sources That Save Rows Per Save Mode]
...
. link:spark-sql-SparkPlan-BaseLimitExec.adoc[BaseLimitExec]
