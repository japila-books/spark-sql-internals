...
.. link:demo/demo-connecting-spark-sql-to-hive-metastore.adoc[Demo: Connecting Spark SQL to Hive Metastore (with Remote Metastore Server)]
.. link:demo/demo-hive-partitioned-parquet-table-partition-pruning.adoc[Demo: Hive Partitioned Parquet Table and Partition Pruning]
...
. link:hive/HiveSessionCatalog.adoc[HiveSessionCatalog]
. link:hive/HiveMetastoreCatalog.adoc[HiveMetastoreCatalog]

. link:hive/RelationConversions.adoc[RelationConversions]
. link:hive/ResolveHiveSerdeTable.adoc[ResolveHiveSerdeTable]
. link:hive/DetermineTableStats.adoc[DetermineTableStats]
. link:hive/HiveAnalysis.adoc[HiveAnalysis]
...
.. link:spark-sql-StaticSQLConf.adoc[StaticSQLConf]
...
.. link:PrunedInMemoryFileIndex.adoc[PrunedInMemoryFileIndex]
...
. link:spark-sql-ParquetReadSupport.adoc[ParquetReadSupport]
. link:spark-sql-RecordReaderIterator.adoc[RecordReaderIterator]
...
.. link:spark-sql-Optimizer.adoc[Catalyst Optimizer]

. link:spark-sql-SparkPlanner.adoc[SparkPlanner]
.. link:spark-sql-SparkStrategy.adoc[SparkStrategy]
.. link:spark-sql-SparkStrategies.adoc[SparkStrategies]

. link:spark-sql-LogicalPlanStats.adoc[LogicalPlanStats]
.. link:spark-sql-Statistics.adoc[Statistics]
.. link:spark-sql-HintInfo.adoc[HintInfo]
.. link:spark-sql-LogicalPlanVisitor.adoc[LogicalPlanVisitor]
...
. link:spark-sql-SparkPlan-Partitioning.adoc[Partitioning]
.. link:spark-sql-HashPartitioning.adoc[HashPartitioning]

. link:spark-sql-Distribution.adoc[Distribution]
