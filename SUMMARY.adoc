...
. link:spark-sql-DataSourceReader.adoc[DataSourceReader Contract]
.. link:spark-sql-SupportsPushDownFilters.adoc[SupportsPushDownFilters Contract -- Data Source Readers with Filter Pushdown Optimization Support]
...
. link:spark-sql-DataSourceWriter.adoc[DataSourceWriter Contract]

. link:spark-sql-SessionConfigSupport.adoc[SessionConfigSupport Contract -- Data Sources with Session-Scoped Configuration Options]

. link:spark-sql-InputPartition.adoc[InputPartition Contract]
. link:spark-sql-InputPartitionReader.adoc[InputPartitionReader Contract]
...
. link:spark-sql-PartitionedFile.adoc[PartitionedFile -- Part of File in FileFormat Data Sources]
