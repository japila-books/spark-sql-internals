...
. link:spark-sql.adoc[Spark SQL -- Processing Structured Data with Relational Queries on Massive Scale]
...
. link:spark-sql-ExternalCatalog.adoc[ExternalCatalog -- Base Metastore of Permanent Relational Entities]
.. link:spark-sql-InMemoryCatalog.adoc[InMemoryCatalog]
.. link:spark-sql-HiveExternalCatalog.adoc[HiveExternalCatalog -- Hive-Specific Metastore of Permanent Relational Entities]
...
.. link:spark-sql-hive-metastore.adoc[External Hive Metastore]
