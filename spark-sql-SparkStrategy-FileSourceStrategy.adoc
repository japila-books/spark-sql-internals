...
`apply` only cares about link:spark-sql-LogicalPlan.adoc[logical plans] with a link:spark-sql-LogicalPlan-LogicalRelation.adoc[LogicalRelation] with a link:spark-sql-BaseRelation-HadoopFsRelation.adoc[HadoopFsRelation].
