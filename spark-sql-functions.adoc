...
`org.apache.spark.sql.functions` object defines built-in standard functions to work with values in link:spark-sql-Column.adoc[Columns].
...
| link:spark-sql-collection-functions.adoc#array_contains[array_contains]
|
