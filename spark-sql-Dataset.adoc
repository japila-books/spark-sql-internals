...
1. link:spark-sql-LogicalPlan-LogicalRelation.adoc[LogicalRelation] with link:spark-sql-FileRelation.adoc[FileRelation] as the link:spark-sql-LogicalPlan-LogicalRelation.adoc#relation[BaseRelation]

1. link:spark-sql-FileRelation.adoc[FileRelation]

1. link:spark-sql-LogicalPlan-HiveTableRelation.adoc[HiveTableRelation]

`inputFiles` then requests the logical operators for their underlying files:

1. link:spark-sql-FileRelation.adoc#inputFiles[inputFiles] of the `FileRelations`

1. link:spark-sql-CatalogStorageFormat.adoc#locationUri[locationUri] of the `HiveTableRelation`
...
=== [[apply]] Creating Dataset For SparkSession and LogicalPlan -- `apply` Method
