...
`CodegenSupport` is the <<contract, contract>> in Spark SQL for link:spark-sql-SparkPlan.adoc[physical operators] that support *Java code generation* (aka *whole-stage codegen*).
