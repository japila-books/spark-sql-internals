...
-----------------|---------
 ...
 [LogicalRelation](../logical-operators/LogicalRelation.md) with [PrunedFilteredScan](../PrunedFilteredScan.md) relation | <ul><li>[pruneFilterProject](#pruneFilterProject) (with the [RDD conversion to RDD[InternalRow]](#toCatalystRDD) as part of `scanBuilder`)</li><li>Matches [JDBCRelation](../jdbc/JDBCRelation.md) exclusively</li></ul>
