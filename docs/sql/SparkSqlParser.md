...
`SparkSqlParser` is used in [SparkSession.sql](../spark-sql-SparkSession.md#sql) to translate a SQL text to a [logical operator](../logical-operators/LogicalPlan.md).
