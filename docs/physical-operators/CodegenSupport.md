...
TIP: Use spark-sql-debugging-query-execution.md#debugCodegen[debugCodegen] or spark-sql-QueryExecution.md#debug[QueryExecution.debug.codegen] methods to access the generated Java source code for a structured query.
