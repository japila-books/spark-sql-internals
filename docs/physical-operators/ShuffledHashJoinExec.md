...
`doExecute` requests link:spark-sql-HashJoin.adoc#streamedPlan[streamedPlan] physical operator to link:SparkPlan.md#execute[execute] (and generate a `RDD[InternalRow]`).
