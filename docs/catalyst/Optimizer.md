...
You can access the optimized logical plan of a structured query (as a [Dataset](../dataset/index.md)) using [Dataset.explain](../dataset/index.md#explain) basic action (with `extended` flag enabled) or SQL's `EXPLAIN EXTENDED` SQL command.
