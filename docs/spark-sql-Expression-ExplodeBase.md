...
`ExplodeBase` is a <<spark-sql-Expression-UnaryExpression.adoc#, unary expression>> and <<Generator, Generator>> with link:spark-sql-Expression.adoc#CodegenFallback[CodegenFallback].
