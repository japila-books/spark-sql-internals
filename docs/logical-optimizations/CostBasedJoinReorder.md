...
`CostBasedJoinReorder` is a [base logical optimization](../Optimizer.md#batches) that <<apply, reorders joins>> in spark-sql-cost-based-optimization.md[cost-based optimization].
