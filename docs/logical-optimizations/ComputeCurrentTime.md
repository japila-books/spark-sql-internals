...
`ComputeCurrentTime` is a [base logical optimization](../catalyst/Optimizer.md#batches) that <<apply, computes the current date and timestamp>>.

`ComputeCurrentTime` is part of the [Finish Analysis](../catalyst/Optimizer.md#ComputeCurrentTime) once-executed batch in the standard batches of the [Logical Optimizer](../catalyst/Optimizer.md).
