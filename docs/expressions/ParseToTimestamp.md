...
`ParseToTimestamp` is a [RuntimeReplaceable](RuntimeReplaceable.md) expression to represent [to_timestamp](../standard-functions//datetime.md#to_timestamp) standard function (in logical query plans).
