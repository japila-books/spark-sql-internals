...
a| Flag that controls...FIXME

Used when the following physical operators are requested to describe a distributed computation as an RDD of internal rows (aka _execute_):
