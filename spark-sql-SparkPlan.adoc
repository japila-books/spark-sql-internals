...
Specifies the required *partition requirements* (_aka_ *child output distributions*) of the input data, i.e. how link:spark-sql-catalyst-TreeNode.adoc#children[children] physical operators' output is split across partitions.
...
=== [[outputPartitioning]] Output Data Partitioning -- `outputPartitioning` Method
...
`outputPartitioning` specifies the *output data partitioning*, i.e. a hint for the Spark Physical Optimizer for the number of partitions the output of the physical operator should be split across.
...
=== [[outputOrdering]] Output Data Ordering -- `outputOrdering` Method
...
`outputOrdering` specifies the *output data ordering*, i.e. a hint for the Spark Physical Optimizer for the sorting (ordering) of the data in each partition.

`outputOrdering` defaults to a no ordering (`Nil`).
