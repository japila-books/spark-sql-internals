...
`outputOrdering` specifies the *output data ordering requirements* of the physical operator, i.e. a hint for the Spark Physical Optimizer for the sorting (ordering) of the data in each partition.
