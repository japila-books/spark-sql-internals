...
CAUTION: FIXME Picture with multiple stages of logical => physical translation, i.e. a logical query plan to its physical execution plan and a Dataset-based logical description to a RDD-based physical description.
