== [[CatalogTable]] CatalogTable -- Table Metadata in SessionCatalog

`CatalogTable` is the metadata of a table in a link:spark-sql-SessionCatalog.adoc[SessionCatalog].
