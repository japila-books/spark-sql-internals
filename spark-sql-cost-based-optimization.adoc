...
You first use <<ANALYZE-TABLE, ANALYZE TABLE>> SQL command to compute <<statistics, statistics>> that you can later inspect using <<DESCRIBE-EXTENDED, DESCRIBE EXTENDED>> SQL command.

=== [[statistics]] Statistics

The (cost) statistics can be computed for tables, partitions and columns and are as follows:
