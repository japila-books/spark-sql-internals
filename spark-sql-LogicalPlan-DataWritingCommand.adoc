...
| [[SaveAsHiveFile]] Commands that write query result as Hive files (i.e. xref:spark-sql-LogicalPlan-InsertIntoHiveDirCommand.adoc[InsertIntoHiveDirCommand] and xref:spark-sql-LogicalPlan-InsertIntoHiveTable.adoc[InsertIntoHiveTable])
