...
| [[ResolveInlineTables]] <<spark-sql-Analyzer-ResolveInlineTables.adoc#, ResolveInlineTables>>
| Resolves <<spark-sql-LogicalPlan-UnresolvedInlineTable.adoc#, UnresolvedInlineTable>> operators to <<spark-sql-LogicalPlan-LocalRelation.adoc#, LocalRelations>>

| link:spark-sql-TypeCoercion.adoc#typeCoercionRules[TypeCoercion.typeCoercionRules]
|
| <<extendedResolutionRules, extendedResolutionRules>>
|
