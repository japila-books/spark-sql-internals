...
a| Optimized <<spark-sql-SparkPlan.adoc#, physical query plan>> that is in the final "shape" and ready for execution, i.e. the <<sparkPlan, physical sparkPlan>> with <<prepareForExecution, physical preparation rules applied>>.
