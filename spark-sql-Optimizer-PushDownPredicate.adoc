== [[PushDownPredicate]] PushDownPredicate -- Predicate Pushdown / Filter Pushdown Logical Optimization

`PushDownPredicate` is a *logical optimization* that <<apply, removes (eliminates) View logical operators from a logical query plan>>.
