...
=== [[schema]] Relation Schema -- `schema` Property
...
NOTE: `schema` is part of link:spark-sql-BaseRelation.adoc#schema[BaseRelation Contract] to return the link:spark-sql-StructType.adoc[schema] of a relation.
