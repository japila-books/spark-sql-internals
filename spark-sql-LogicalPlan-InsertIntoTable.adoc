...
| [[InsertIntoHiveTable]] When <<spark-sql-Analyzer-HiveAnalysis.adoc#apply, HiveAnalysis>> resolution rule transforms `InsertIntoTable` with a link:hive/HiveTableRelation.adoc[HiveTableRelation]
