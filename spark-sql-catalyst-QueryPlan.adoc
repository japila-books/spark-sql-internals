...
=== [[simpleString]] Simple (Basic) Text Node Description with State Prefix -- `simpleString` Method
...
`verboseString` simply returns the <<simpleString, simple (basic) text node description with state prefix>>.
