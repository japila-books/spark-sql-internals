...
* link:spark-sql-QueryExecution.adoc#executedPlan[Optimized physical query plan ready for execution] (after requesting `SessionState` to link:spark-sql-SessionState.adoc#executePlan[execute] the analyzed logical plan)
