...
1. `CatalogImpl` is requested to link:spark-sql-CatalogImpl.adoc#makeTable[makeTable], link:spark-sql-CatalogImpl.adoc#listColumns[listColumns] and link:spark-sql-CatalogImpl.adoc#refreshTable[refreshTable]
