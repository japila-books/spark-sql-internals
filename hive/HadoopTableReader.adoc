...
`HadoopTableReader` is used by link:../spark-sql-SparkPlan-HiveTableScanExec.adoc[HiveTableScanExec] physical operator when requested to link:../spark-sql-SparkPlan-HiveTableScanExec.adoc#doExecute[execute].
