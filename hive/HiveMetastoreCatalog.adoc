...
`HiveMetastoreCatalog` is used by link:HiveSessionCatalog.adoc#metastoreCatalog[HiveSessionCatalog] for link:../spark-sql-Analyzer-RelationConversions.adoc[RelationConversions] logical evaluation rule.
