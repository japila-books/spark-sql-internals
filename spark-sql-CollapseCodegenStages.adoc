== [[CollapseCodegenStages]] CollapseCodegenStages Physical Optimization Rule -- Collapsing Physical Operators for Whole-Stage Java Code Generation (aka Whole-Stage CodeGen)
