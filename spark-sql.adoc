...
1. link:spark-sql-QueryExecution.adoc#optimizedPlan[Logical Optimization] (using link:spark-sql-SparkOptimizer.adoc[rule-based] and link:spark-sql-cost-based-optimization.adoc[cost-based] optimizations)
