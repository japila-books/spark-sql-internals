== [[LogicalPlan]] LogicalPlan -- Logical Relational Operator with Children and Expressions / Logical Query Plan
...
=== [[resolve]] Resolving Attribute By Name Parts -- `resolve` Internal Method
